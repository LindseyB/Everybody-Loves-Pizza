...
init -1 python hide:
    ...
    config.screen_width = 930
    config.screen_height = 540

    ## This controls the title of the window, when Ren'Py is
    ## running in a window.

    config.window_title = u"Everybody Loves Pizza"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Everybody Loves Pizza"
    config.version = "0.0"
    ...
    #########################################
    ## These let you customize the default font used for text in Ren'Py.f
...
python early:
    config.save_directory = "Everybody Loves Pizza-1464538013"
...
init python:
    ...
    build.directory_name = "Everybody_Loves_Pizza-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Everybody_Loves_Pizza"
